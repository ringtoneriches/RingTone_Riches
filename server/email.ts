                  ...
                  <td style="padding: 20px;">
                    ...
                    <table width="100%" cellpadding="8" cellspacing="0">
                      <tr>
                        ...
                        <td style="color: #ffffff; font-size: 14px; font-weight: bold; text-align: right;">#${orderData.orderId}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="color: #999999; font-size: 14px;">Item:</td>
                        <td style="color: #ffffff; font-size: 14px; text-align: right;">${orderData.itemName}</td>
                      </tr>
                      <tr>
