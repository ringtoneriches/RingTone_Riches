    ...
    <AdminLayout>
      <div className="space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-foreground" data-testid="heading-scratch-card">
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <CompetitionForm
              fixedType="scratch"
              onSubmit={(data) => createMutation.mutate({ ...data, type: "scratch" })}
          ...
          <DialogContent className="max-w-2xl">
            ...
            {editingCompetition && (
              <CompetitionForm
                ...
                fixedType="scratch"
                onSubmit={(data) =>
                  updateMutation.mutate({ id: editingCompetition.id, data: { ...data, type: "scratch" } })
                }
