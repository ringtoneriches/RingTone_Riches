...
function CompetitionForm({
  ...
  return (
    <Tabs defaultValue="basic" className="w-full">
      ...
      <TabsContent value="prizes" className="mt-4 max-h-[60vh] overflow-y-auto pr-2">
        {form.type === "spin" && (
          <PrizeConfigSpin
    ...
    <AdminLayout>
      <div className="space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-foreground" data-testid="heading-spin-wheel">
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <CompetitionForm
              fixedType="spin"
              onSubmit={(data) => createMutation.mutate({ ...data, type: "spin" })}
          ...
          <DialogContent className="max-w-2xl">
            ...
            {editingCompetition && (
              <CompetitionForm
                ...
                fixedType="spin"
                onSubmit={(data) =>
                  updateMutation.mutate({ id: editingCompetition.id, data: { ...data, type: "spin" } })
                }
...
function WheelSettingsDialog({
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/game-spin-config"] });
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className={`px-3 py-1 rounded-md ${isProbabilityValid ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'}`}>
                Total: {totalProbability}% {isProbabilityValid ? '✓' : '(must be 100%)'}
              </div>
            </div>
            
            <div className="grid gap-3 max-h-[50vh] overflow-y-auto pr-2">
              {segments.map((segment, index) => (
                <div key={segment.id} className="border border-border rounded-lg p-4 space-y-3 bg-card">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => updateSegment(index, { rewardType: e.target.value as any })}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateSegment(index, { rewardValue: parseFloat(e.target.value) || 0 })}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateSegment(index, { maxWins: e.target.value ? parseInt(e.target.value) : null })}
